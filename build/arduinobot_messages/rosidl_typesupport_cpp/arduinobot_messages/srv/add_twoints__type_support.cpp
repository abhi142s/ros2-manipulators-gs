...
static const _AddTwoints_Request_type_support_symbol_names_t _AddTwoints_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arduinobot_messages, srv, AddTwoints_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, arduinobot_messages, srv, AddTwoints_Request)),
  }
};
...
get_message_type_support_handle<arduinobot_messages::srv::AddTwoints_Request>()
{
  return &::arduinobot_messages::srv::rosidl_typesupport_cpp::AddTwoints_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, arduinobot_messages, srv, AddTwoints_Request)() {
  return get_message_type_support_handle<arduinobot_messages::srv::AddTwoints_Request>();
}
...
static const _AddTwoints_Response_type_support_symbol_names_t _AddTwoints_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arduinobot_messages, srv, AddTwoints_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, arduinobot_messages, srv, AddTwoints_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<arduinobot_messages::srv::AddTwoints_Response>()
{
  return &::arduinobot_messages::srv::rosidl_typesupport_cpp::AddTwoints_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, arduinobot_messages, srv, AddTwoints_Response)() {
  return get_message_type_support_handle<arduinobot_messages::srv::AddTwoints_Response>();
}
...
static const _AddTwoints_type_support_symbol_names_t _AddTwoints_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arduinobot_messages, srv, AddTwoints)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, arduinobot_messages, srv, AddTwoints)),
  }
};
...
get_service_type_support_handle<arduinobot_messages::srv::AddTwoints>()
{
  return &::arduinobot_messages::srv::rosidl_typesupport_cpp::AddTwoints_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, arduinobot_messages, srv, AddTwoints)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<arduinobot_messages::srv::AddTwoints>();
}
