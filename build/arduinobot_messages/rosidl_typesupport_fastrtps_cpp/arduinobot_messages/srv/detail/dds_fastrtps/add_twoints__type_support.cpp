...
#include "arduinobot_messages/srv/detail/add_twoints__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arduinobot_messages::srv::AddTwoints_Request;
    is_plain =
      (
      offsetof(DataType, b) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const arduinobot_messages::srv::AddTwoints_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<arduinobot_messages::srv::AddTwoints_Request *>(
    untyped_ros_message);
...
{
  return &arduinobot_messages::srv::typesupport_fastrtps_cpp::_AddTwoints_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = arduinobot_messages::srv::AddTwoints_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const arduinobot_messages::srv::AddTwoints_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<arduinobot_messages::srv::AddTwoints_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &arduinobot_messages::srv::typesupport_fastrtps_cpp::_AddTwoints_Response__handle;
}
...
{
  return &arduinobot_messages::srv::typesupport_fastrtps_cpp::_AddTwoints__handle;
}
