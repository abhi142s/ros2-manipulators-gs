...
#include "arduinobot_messages/srv/detail/euler_to_quaternion__rosidl_typesupport_fastrtps_c.h"
...
using _EulerToQuaternion_Request__ros_msg_type = arduinobot_messages__srv__EulerToQuaternion_Request;
...
size_t get_serialized_size_arduinobot_messages__srv__EulerToQuaternion_Request(
  const void * untyped_ros_message,
...
static uint32_t _EulerToQuaternion_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_arduinobot_messages__srv__EulerToQuaternion_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arduinobot_messages
size_t max_serialized_size_arduinobot_messages__srv__EulerToQuaternion_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arduinobot_messages__srv__EulerToQuaternion_Request;
    is_plain =
      (
...
static size_t _EulerToQuaternion_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arduinobot_messages__srv__EulerToQuaternion_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arduinobot_messages, srv, EulerToQuaternion_Request)() {
...
using _EulerToQuaternion_Response__ros_msg_type = arduinobot_messages__srv__EulerToQuaternion_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arduinobot_messages
size_t get_serialized_size_arduinobot_messages__srv__EulerToQuaternion_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _EulerToQuaternion_Response__ros_msg_type * ros_message = static_cast<const _EulerToQuaternion_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_arduinobot_messages__srv__EulerToQuaternion_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arduinobot_messages
size_t max_serialized_size_arduinobot_messages__srv__EulerToQuaternion_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = arduinobot_messages__srv__EulerToQuaternion_Response;
    is_plain =
      (
      offsetof(DataType, w) +
      last_member_size
...
static size_t _EulerToQuaternion_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arduinobot_messages__srv__EulerToQuaternion_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arduinobot_messages, srv, EulerToQuaternion_Response)() {
...
// already included above
// #include "arduinobot_messages/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "arduinobot_messages/srv/euler_to_quaternion.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arduinobot_messages, srv, EulerToQuaternion)() {
